...
class KylinServerCommands:
    ...
    @staticmethod
    def start_pxe_services(params):
        try:
            return PXECommands().start_pxe_services(params)
        except Exception as e:
            return {'status': 'error', 'message': str(e)}

    @staticmethod
    def stop_pxe_services(params):
        try:
            return PXECommands().stop_pxe_services(params)
        except Exception as e:
            return {'status': 'error', 'message': str(e)}

    @staticmethod
    def get_pxe_status(params):
        try:
            return PXECommands().get_pxe_status(params)
        except Exception as e:
            return {'status': 'error', 'message': str(e)}

    @staticmethod
    def update_pxe_config(params):
        try:
            return PXECommands().update_pxe_config(params)
        except Exception as e:
            return {'status': 'error', 'message': str(e)}

    @staticmethod
    def get_pxe_client_list(params):
        try:
            return PXECommands().get_client_list(params)
        except Exception as e:
            return {'status': 'error', 'message': str(e)}

    @staticmethod
    def get_pxe_network_info(params):
        try:
            return PXECommands().get_network_info(params)
        except Exception as e:
            return {'status': 'error', 'message': str(e)}

    @staticmethod
    def rescan_pxe_isos(params):
        try:
            return PXECommands().rescan_isos(params)
        except Exception as e:
            return {'status': 'error', 'message': str(e)}

    @staticmethod
    def set_pxe_blackwhitelist(params):
        try:
            return PXECommands().set_blackwhitelist(params)
        except Exception as e:
            return {'status': 'error', 'message': str(e)}

    @staticmethod
    def get_pxe_blackwhitelist(params):
        try:
            return PXECommands().get_blackwhitelist(params)
        except Exception as e:
            return {'status': 'error', 'message': str(e)}

    @staticmethod
    def get_pxe_logs(params):
        try:
            return PXECommands().get_logs(params)
        except Exception as e:
            return {'status': 'error', 'message': str(e)}
...
def main():
    ...
    server.register_handler('start_pxe_services', KylinServerCommands.start_pxe_services)
    server.register_handler('stop_pxe_services', KylinServerCommands.stop_pxe_services)
    server.register_handler('get_pxe_status', KylinServerCommands.get_pxe_status)
    server.register_handler('update_pxe_config', KylinServerCommands.update_pxe_config)
    server.register_handler('get_pxe_client_list', KylinServerCommands.get_pxe_client_list)
    server.register_handler('get_pxe_network_info', KylinServerCommands.get_pxe_network_info)
    server.register_handler('rescan_pxe_isos', KylinServerCommands.rescan_pxe_isos)
    server.register_handler('set_pxe_blackwhitelist', KylinServerCommands.set_pxe_blackwhitelist)
    server.register_handler('get_pxe_blackwhitelist', KylinServerCommands.get_pxe_blackwhitelist)
    server.register_handler('get_pxe_logs', KylinServerCommands.get_pxe_logs)
