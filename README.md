...
```bash
# 下载最新版本
wget https://github.com/tubinchun/Operation_Tools/releases/download/v1.0.3/kylin-system-tools_1.0.3_amd64.deb

# 安装
sudo dpkg -i kylin-system-tools_1.0.3_amd64.deb
...
# 安装
sudo dpkg -i output/kylin-system-tools_1.0.3_amd64.deb
```
