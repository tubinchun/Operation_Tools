...
class KylinClient:
    ...
    def start_pxe_services(self):
        return self.send_request('start_pxe_services')

    def stop_pxe_services(self):
        return self.send_request('stop_pxe_services')

    def get_pxe_status(self):
        return self.send_request('get_pxe_status')

    def update_pxe_config(self, params):
        return self.send_request('update_pxe_config', params)

    def get_pxe_client_list(self):
        return self.send_request('get_pxe_client_list')

    def get_pxe_network_info(self):
        return self.send_request('get_pxe_network_info')

    def rescan_pxe_isos(self):
        return self.send_request('rescan_pxe_isos')

    def set_pxe_blackwhitelist(self, params):
        return self.send_request('set_pxe_blackwhitelist', params)

    def get_pxe_blackwhitelist(self):
        return self.send_request('get_pxe_blackwhitelist')

    def get_pxe_logs(self):
        return self.send_request('get_pxe_logs')
